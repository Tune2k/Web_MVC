...
//}
function changeModelStyle(element, rotation) {
    const modelViewer = element.closest('.product-card').querySelector('model-viewer');
    if (modelViewer) {
        modelViewer.setAttribute('camera-orbit', `${rotation}deg 90deg 500px`);
    }
}